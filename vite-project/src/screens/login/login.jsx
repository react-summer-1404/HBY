...
export const Login = () => {
  ...
  return (
    <div
      className="flex min-h-screen  bg-[#3C8B85] font-sans relative overflow-hidden"
      dir="rtl"
    >
      {/* آیکون منو بالا */}
      ...
      <div className="relative  w-1/2   lg:flex flex-col items-center justify-center overflow-hidden hidden">
        {/* تصویر موتور */}
        <img src={motor} alt="موتور" className="w-[800px] mt-10 z-20 " />
      ...
      <div className="lg:top-[200px] relative top-[300px] w-[700px] h-[500px] flex flex-col justify-center items-center px-14 py-10 lg:bg-[#F5F5F5] bg-[#3C8B85] ">
        ...
        <img
          src={bgimg}
          className="w-[800px]  absolute -z-[2px] top-[-50px] lg:hidden"
        />
      ...
      <img
        src={logodr2}
        className="block absolute h-[45px] top-[20px] right-[210px]  lg:hidden"
      />
      ...
      <img
        src={Home4}
        className="block absolute h-[40px] top-[20px] right-[20px]  lg:hidden"
      />
    </div>
  );
};
