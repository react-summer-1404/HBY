...
const ForgetPassBox_1 = () => {
  return (
    ...
    <div className="flex flex-col md:justify-center items-center bg-[#F5F5F5] shadow-box rounded-t-[80px] md:mt-[80px] w-1/1 md:rounded-[20px] md:w-[561px] md:h-[491px] px-[30px] py-[64px]">
