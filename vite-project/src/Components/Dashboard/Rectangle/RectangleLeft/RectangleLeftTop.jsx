...
const RectangleLeftTop = () => {
  return (
    <div dir="rtl">
      <div className="p-6 pr-10 pl-10  flex-col justify-center items-center rounded-2xl w-[700px] h-[340px] bg-[#FFFFFF] ">
        <div className="flex justify-between ">
          <h1 className="text-[20px] text-fuchsia-800">جدید ترین رزرو</h1>
...
export default RectangleLeftTop
